    ...
    <section>
        <c:forEach items="${BoadList}" var="list">
            <form:form action="../boad/SuccessWirte" method="post" modelAttribute="boadWriteVo">
                ...
                <form:hidden path="nickname" value="${BoadList.nickname}"/>
                <div class="WriteTitle">
                    <fomr:input path="title" cssClass="write_title_input" value="${BoadList.title}" placeholder="제목"/>
